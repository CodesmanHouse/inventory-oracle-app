            ...
            return (
              <Card key={po.id} className="cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => onRowClick(po)}>
                ...
                <CardContent className="px-4 pb-3 space-y-1 text-sm">
                  ...
                  <div className="flex justify-between"><span className="text-muted-foreground">Total</span><span className="font-mono font-medium">UGX {po.totalCost.toLocaleString("en-UG", { minimumFractionDigits: 2 })}</span></div>
            ...
            {paged.map((po) => {
              ...
              return (
                <TableRow key={po.id} className="cursor-pointer hover:bg-muted/50" onClick={() => onRowClick(po)}>
                  ...
                  <TableCell className="text-right font-mono text-sm font-medium">UGX {po.totalCost.toLocaleString("en-UG", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>

          ...
          {purchaseOrder.items.map((li) => {
            ...
            return (
              <tr key={li.id} className="border-b border-gray-300">
                ...
                <td className="py-1.5 text-right font-mono">UGX {li.unitCost.toFixed(2)}</td>
                <td className="py-1.5 text-right font-mono font-medium">
                  UGX {(li.quantityOrdered * li.unitCost).toFixed(2)}
                </td>
              </tr>
            );
          })}
        ...
        <tfoot>
          <tr className="border-t-2 border-black">
            ...
            <td className="py-2 text-right font-mono font-bold">
              UGX {purchaseOrder.totalCost.toLocaleString("en-UG", {

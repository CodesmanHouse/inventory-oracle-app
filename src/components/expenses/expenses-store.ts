...
function seed(): ExpensesData {
  ...
  const expenses: Expense[] = [
    { id: "e1", reference: mkRef(1), date: iso(-1), type: "employee", employee: "Wanjiru Mwangi", department: "Sales", categoryId: "c3", vendor: "Java House", amount: 4_800, currency: "KES", paymentMethod: "card", description: "Client lunch · Q3 pitch", attachment: "receipt-4800.pdf", status: "submitted", reimbursable: true, reimbursed: false, approvedBy: null, rejectedReason: null, createdAt: iso(-1) },
    { id: "e2", reference: mkRef(2), date: iso(-2), type: "travel", employee: "Brian Otieno", department: "Operations", categoryId: "c2", vendor: "Kenya Airways", amount: 38_500, currency: "KES", paymentMethod: "company_card", description: "Nairobi → Mombasa site visit", attachment: "boarding.pdf", status: "approved", reimbursable: false, reimbursed: false, approvedBy: "Faith Njeri", rejectedReason: null, travel: { destination: "Mombasa", purpose: "Warehouse audit", mileage: 0 }, createdAt: iso(-2) },
    { id: "e3", reference: mkRef(3), date: iso(-3), type: "vendor", employee: "Faith Njeri", department: "Procurement", categoryId: "c6", vendor: "Mavuno Cleaning Co.", amount: 22_000, currency: "KES", paymentMethod: "bank_transfer", description: "May janitorial services", attachment: null, status: "paid", reimbursable: false, reimbursed: false, approvedBy: "Faith Njeri", rejectedReason: null, createdAt: iso(-3) },
    { id: "e4", reference: mkRef(4), date: iso(-4), type: "recurring", employee: "System", department: "Engineering", categoryId: "c5", vendor: "GitHub Enterprise", amount: 18_400, currency: "KES", paymentMethod: "company_card", description: "Monthly seats × 8", attachment: null, status: "paid", reimbursable: false, reimbursed: false, approvedBy: "Faith Njeri", rejectedReason: null, recurring: { frequency: "monthly", nextRun: iso(26) }, createdAt: iso(-4) },
    { id: "e5", reference: mkRef(5), date: iso(-5), type: "employee", employee: "Kevin Kiprotich", department: "Marketing", categoryId: "c1", vendor: "Text Book Centre", amount: 6_200, currency: "KES", paymentMethod: "cash", description: "Print collateral", attachment: "rec-6200.jpg", status: "rejected", reimbursable: true, reimbursed: false, approvedBy: null, rejectedReason: "Use procurement channel", createdAt: iso(-5) },
    { id: "e6", reference: mkRef(6), date: iso(-6), type: "travel", employee: "Wanjiru Mwangi", department: "Sales", categoryId: "c2", vendor: "Uber", amount: 2_300, currency: "KES", paymentMethod: "mobile", description: "Client visits · Westlands", attachment: null, status: "reimbursed", reimbursable: true, reimbursed: true, approvedBy: "Faith Njeri", rejectedReason: null, travel: { destination: "Westlands", purpose: "Client meetings", mileage: 0 }, createdAt: iso(-6) },
    { id: "e7", reference: mkRef(7), date: iso(-7), type: "vendor", employee: "Brian Otieno", department: "Operations", categoryId: "c4", vendor: "Kenya Power", amount: 64_300, currency: "KES", paymentMethod: "bank_transfer", description: "May electricity", attachment: "kplc.pdf", status: "approved", reimbursable: false, reimbursed: false, approvedBy: "Faith Njeri", rejectedReason: null, createdAt: iso(-7) },
    { id: "e8", reference: mkRef(8), date: iso(-9), type: "employee", employee: "Mercy Achieng", department: "HR", categoryId: "c3", vendor: "Artcaffé", amount: 3_400, currency: "KES", paymentMethod: "card", description: "Candidate breakfast interview", attachment: null, status: "submitted", reimbursable: true, reimbursed: false, approvedBy: null, rejectedReason: null, createdAt: iso(-9) },
  ];
